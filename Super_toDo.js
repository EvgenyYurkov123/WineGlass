...
// * npx sequelize model:generate --name Сard --attributes title:string,quantity:integer,price:int,image:string,category_id:integer
// npx sequelize model:generate --name User --attributes userName:string,userEmail:string,password:string,phone:string,firstName:string,lastName:string,role:string,age:integer
// npx sequelize model:generate --name UserFavorit --attributes favoriteId:integer,userId:integer
// npx sequelize model:generate --name Favourite --attributes userId:integer,productId:integer
// npx sequelize model:generate --name Product --attributes category:string,imageProduct:string,article:string,rate:integer,name:string,brand:string,country:string,region:string,price:integer,sugar:string,color:string,type:string,productClass:string,age:integer,popular:string,volume:integer,strong:integer,count:integer,balance:integer
// npx sequelize model:generate --name Category --attributes name:string
// npx sequelize model:generate --name Basket --attributes userId:integer,productId:integer,quantity:integer,total:integer
// npx sequelize model:generate --name BasketProduct --attributes productId:integer,basketId:integer
...
// * npx sequelize seed:generate --name CreateProducts
